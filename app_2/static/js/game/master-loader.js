...
if (!window.config.unityWebglLoaderUrl) {
    ...
    switch (year) {
        case "2019":
            window.config.unityWebglLoaderUrl = 1 === minor ? static_file_game + "UnityLoader.2019.1.js" : static_file_game + "UnityLoader.2019.2.js";
            break;
        default:
            window.config.unityWebglLoaderUrl = static_file_game + "UnityLoader.js"
    }
}
var sdkScript = document.createElement("script");
sdkScript.src = static_file_game + "poki-sdk.js", sdkScript.onload = function() {
