document.addEventListener('DOMContentLoaded', function() {
    ...
    var bool_mode = url.includes('?mode')
    var type_game = '';
    if(bool_mode){
        mode = url.split('?mode=')[1];
        type_game = mode;
    }else{
        type_game = 'real';
    }

    function blockedGainBtn(){
        document.getElementsByClassName('container-btn-stop-game')[0].style.display = 'none';
        if(document.getElementsByClassName('container-btn-stop-game')[0].classList.contains('click')){
            document.getElementsByClassName('container-btn-stop-game')[0].classList.remove('click');
        };
    }

    function demo_game(){
        //await var dynamicStaticFile is load
        ...
        define("scripts/game.js", function(exports) {
            ...
            exports.start = function() {
                snd = sound.create(path_sound + "throw");
                boomSnd = sound.create(path_sound + "boom");
        ...
        define("scripts/sence.js", function(exports) {
            ...
            var gameStartSnd;
            exports.init = function() {
                menuSnd = sound.create(path_sound + "menu");
                gameStartSnd = sound.create(path_sound + "start");
            ...
            exports.showMenu = function(callback) {
                ...
                [melancia].forEach(function(f) {
                    f.isHomeMenu = 1;
                });
                melancia.isNewGameIcon = 1;
                var group = [[homeMask, 0], [logo, 0], [homeDesc, 1500], [newGame, 2000], [melancia, 2000]];
                group.invoke("show");
        ...
        define("scripts/timeline.js", function(exports) {
            ...
            var requestAnimationFrame = function(glob) {
                return glob.requestAnimationFrame || glob.mozRequestAnimationFrame || glob.webkitRequestAnimationFrame || glob.msRequestAnimationFrame || glob.oRequestAnimationFrame || function(callback) {
        ...
        define("scripts/factory/fruit.js", function(exports) {
            ...
            var dropTime = frutSpeed
            , dropXScope = 200
            , shadowPos = 50;
            var infos = {
                boom: [path_image + "fruit/boom.png", 66, 68, 26, 0, 0, null],
                maca: [path_image + "fruit/maca.png", 62, 66, 31, -54, 0, "#98191e"],
                maracuja: [path_image + "fruit/maracuja.png", 62, 62, 37, -50, 0, "#e2bc30"],
                melancia: [path_image + "fruit/melancia.png", 90, 80, 38, -100, 0, "#94b167"],
                manga: [path_image + "fruit/manga.png", 62, 70, 32, -135, 0, "#d99c22"],
                abacate: [path_image + "fruit/abacate.png", 66, 80, 32, -135, 0, "#555b1f"],
                mamao: [path_image + "fruit/mamao.png", 62, 85, 32, -135, 0, "#94aa30"],
                banana: [path_image + "fruit/banana.png", 80, 60, 32, -135, 0, "#f5e330"],
                limao: [path_image + "fruit/limao.png", 65, 65, 37, -50, 0, "#fcf279"],
                roma: [path_image + "fruit/roma.png", 65, 65, 32, -135, 0, "#841d1c"],
                morango: [path_image + "fruit/morango.png", 62, 65, 32, -135, 0, "#c54624"],
                laranja: [path_image + "fruit/laranja.png", 70, 70, 32, -135, 0, "#c27811"],
                kiwi: [path_image + "fruit/kiwi.png", 68, 74, 32, -135, 0, "#76561d"],
                dragao: [path_image + "fruit/dragao.png", 70, 80, 32, -135, 0, "#c34d46"]
            };
            ...
            ClassFruit.prototype.set = function(hide) {
                ...
                , radius = this.radius;
                this.shadow = layer.createImage("fruit", path_image + "shadow.png", this.startX - radius, this.startY - radius + shadowPos, 106, 77);
            ...
            ClassFruit.prototype.onFalling = function(time) {
                this.pos(linearAnim(time, this.brokenPosX, this.fallTargetX - this.brokenPosX, dropTime), dropAnim(time, this.brokenPosY, this.fallTargetY - this.brokenPosY, dropTime));
            }
            ;
        ...
        define("scripts/lib/Player.js", function(exports) {
            ...
            (function() {
                ...
                , bF = function(a) {
                    return function() {
                        throw new Error("Frutinhas: you are calling to method “" + a + "” of removed object")
                    }
                };
                a.pathToRelative = bp;
                if (a.svg) {
        ...
        define("scripts/object/background.js", function(exports) {
            ...
            exports.set = function() {
                image = layer.createImage("default", path_image + "background.jpg", 0, 0, screenW, screenH);
            }
            ;
        ...
        define("scripts/object/developing.js", function(exports) {
            ...
            exports.anims = [];
            exports.set = function() {
                this.image = layer.createImage("default", path_image + "developing.png", 103, 218, 429, 53).hide().scale(1e-5, 1e-5);
            }
            ;
        ...
        define("scripts/object/dojo.js", function(exports) {
            ...
            var tween = require("scripts/lib/tween");
            exports = rotate.create(path_image + "dojo.png", 41, 240, 175, 175, 1e-5, tween.exponential.co, 500);
            ;return exports;
        });
        define("scripts/object/flame.js", function(exports) {
            ...
            ;exports.create = function(ox, oy, start) {
                ...
                var nx = ox
                , ny = oy;
                var image = layer.image(path_image + "smoke.png", nx - 21, ny - 21, 43, 43).hide();
                var flames = {};
        ...
        define("scripts/object/flash.js", function(exports) {
            ...
            exports.set = switchOn ? function() {
                image = layer.createImage("flash", path_image + "flash.png", 0, 0, 358, 20).hide();
                snd = sound.create(path_sound + "splatter");
            }
            : ucren.nul;
        ...
        define("scripts/object/game-over.js", function(exports) {
            ...
            exports.anims = [];
            exports.set = function() {
                this.image = layer.createImage("default", path_image + "game-over.png", (screen.width - 300) / 2, 198, 300, 65).hide().scale(1e-5, 1e-5);
            }
            ;
            exports.show = function(start) {
                timeline.createTask({
        ...
        define("scripts/object/home-desc.js", function(exports) {
            ...
            var tween = require("scripts/lib/tween");
            exports = displacement.create(path_image + "home-desc.png", 209, 120, -161, 140, 7, 12, tween.exponential.co, 500);
            ;return exports;
        });
        define("scripts/object/home-mask.js", function(exports) {
            var displacement = require("scripts/factory/displacement");
            var tween = require("scripts/lib/tween");
            //exports = displacement.create(path_image + "home-mask.png", screenW, 183, 0, -183, 0, 0, tween.exponential.co, 1e3);
            exports = displacement.create(path_image + "home-mask.png", 0, 0, 0, -183, 0, 0, tween.exponential.co, 1e3);
            return exports;
        });
        ...
        define("scripts/object/light.js", function(exports) {
            ...
            exports.overWhiteLight = function() {
                ...
                this.removeLights();
                var dur = 4e3;
                var mask = maskLayer.rect(0, 0, screenW, screenH).attr({
                    fill: "#fff",
                    stroke: "none"
                });
                var control = {
        ...
        define("scripts/object/logo.js", function(exports) {
            var displacement = require("scripts/factory/displacement");
            var tween = require("scripts/lib/tween");
            //exports = displacement.create(path_image + "logo.png?v=1.0", 100, 120, 17, -182, 8, 32, tween.exponential.co, 1e3);
            exports = displacement.create(path_image + "logo.png?v=1.0", 0, 0, 17, -182, 8, 32, tween.exponential.co, 1e3);
            ;return exports;
        });
        define("scripts/object/lose.js", function(exports) {
            ...
            function createPosShow(x) {
                var image = layer.createImage("default", path_image + "lose.png", x - 27, screenH - 150, 54, 50).scale(1e-5, 1e-5);
                var duration = 500;
                var control = {
                    show: function(start) {
                        timeline.createTask({
        ...
        define("scripts/object/new-game.js", function(exports) {
            var rotate = require("scripts/factory/rotate");
            var tween = require("scripts/lib/tween");
            exports = rotate.create(path_image + "new-game.png", (screen.width - 195) / 2, 160, 195, 195, 1e-5, tween.exponential.co, 500);
            ;return exports;
        });
        define("scripts/object/new.js", function(exports) {
            ...
            exports.anims = [];
            exports.set = function() {
                image = layer.createImage("default", path_image + "new.png", sx, sy, sw, sh);
            }
            ;
        ...
        define("scripts/object/ninja.js", function(exports) {
            var displacement = require("scripts/factory/displacement");
            var tween = require("scripts/lib/tween");
            exports = displacement.create(path_image + "ninja.png", 244, 81, 315, -140, 315, 43, {
        ...
        define("scripts/object/quit.js", function(exports) {
            var rotate = require("scripts/factory/rotate");
            var tween = require("scripts/lib/tween");
            exports = rotate.create(path_image + "quit.png", 493, 311, 141, 141, 1e-5, tween.exponential.co, 500);
            ;return exports;
        });
        define("scripts/object/score.js", function(exports) {
            ...
            exports.anims = [];
            exports.set = function() {
                image = layer.createImage("default", path_image + "coin.png", imageSx, 8, 29, 31).hide();
            ...
            exports.number = function(number) {
                //change number to currency brazilian, example currency 1000.00 to 1.000,00
                var currency = formatCurrencyBrazilian(number);
                text1.attr("text", currency);
    ...
    function real_game(){
        verifyUser()
        .then(function(data_game) {
            if(data_game.status_boolean){
                var screenW = screen.width;
                var screenH = screen.height;
                var screenT = 0;
                var screenL = 0;
                var frutSpeed = 1000;
                var scoreNumber = 0;
                var aposta = data_game.data.game.value;
                ...
                define("scripts/game.js", function(exports) {
                    ...
                    exports.gameOver = function() {
                        ...
                        setTimeout(function() {
                            var xhr = new XMLHttpRequest();
                                ...
                                var aleatory_6numbers = Math.floor(Math.random() * 900000) + 100000;
                                data = {
                                    'hash_game': hash_game,
                                    'value': scoreNumber,
                                    'aleatory_6numbers': aleatory_6numbers,
                                    'status': 'finished',
                                    'win': 'false',
                                    'date_now': date_now_string
                                }
                    ...
                    exports.sliceAt = function(fruit, angle) {
                        ...
                        if (fruit.type != "boom") {
                            ...
                            fruitValue = fruitValue * multiplier;
                            
                            score.number((scoreNumber += fruitValue).toFixed(2));
                            this.applyScore(scoreNumber);
                            frutSpeed -= 8;
                            if (scoreNumber >= goal) {
                                document.getElementsByClassName('container-btn-stop-game')[0].addEventListener('click', function(){
                                    var xhr = new XMLHttpRequest();
                                    xhr.open('POST', '/api/v1/game/update', true);
                                    xhr.setRequestHeader('X-CSRFToken', getCSRFToken());
                                    xhr.setRequestHeader('Content-type', 'application/json');
                                ...
                                document.getElementsByClassName('container-btn-stop-game')[0].style.display = 'flex';
                            }else{
                                document.getElementsByClassName('container-btn-stop-game')[0].style.display = 'none';
                                if(document.getElementsByClassName('container-btn-stop-game')[0].classList.contains('click')){
                                    document.getElementsByClassName('container-btn-stop-game')[0].classList.remove('click');
                    ...
                    message.addEventListener("fruit.fallOutOfViewer", function(fruit) {
                        ...
                        if (fruit.type != "boom") {
                            ...
                            scoreNumber -= (fruitPerda * multiplier) * 1.25;
                            if (scoreNumber < 0) { 
                                scoreNumber = 0;
                            }
                            score.number(scoreNumber.toFixed(2));
                ...
                define("scripts/object/score.js", function(exports) {
                    ...
                    exports.set = function() {
                        image = layer.createImage("default", path_image + "coin.png", imageSx, 8, 29, 31).hide();
                        text1 = layer.createText("default", "R$ 0,00", text1Sx, 24, "90-#fc7f0c-#ffec53", "30px").hide();
                        text2 = layer.createText("default", "Meta: " + formatCurrencyBrazilian(goal), text2Sx, 58, "#af7c05", "14px").hide();
                    }
                    ;
                    exports.show = function(start) {
                        timeline.createTask({
    ...
    function verifyUser() {
        return new Promise(function(resolve, reject) {
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '/api/v1/game/status', true);
            xhr.setRequestHeader('X-CSRFToken', getCSRFToken());
            xhr.setRequestHeader('Content-type', 'application/json');
            xhr.onload = function() {
                if (xhr.status === 200) {
