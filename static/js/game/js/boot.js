...
function initApp() {
    ...
    dynamicStaticFile = document.getElementById('dynamicStaticFile').value;
    loadScript(dynamicStaticFile + 'js/game/js/' + 'dependencies.bundle.js');
    loadScript(window.MAIN ? window.MAIN : dynamicStaticFile + 'js/game/js/' + 'index.js');
}
